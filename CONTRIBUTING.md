...
Contributions should preserve the bounded research claim and public/private
repository boundary.
...
- Do not commit secrets, personal information, submission workflow files,
  model weights, local artifacts, or absolute machine paths.
